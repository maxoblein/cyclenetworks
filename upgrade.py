...
def colour_by_batch():
    ...
    fig, ax = ox.plot_graph(G_upgrade, node_size=0, edge_color=ec, edge_linewidth=1.5, edge_alpha=0.7,save=False, show=False, filepath = 'lpic_figs/coloured_by_batch.pdf',bgcolor='lightgray')
