...
function [onebatchMeanFlowWeightedProportion,twobatchMeanFlowWeightedProportion,onebatchMeanEffectiveLengthFlowWeighted,twobatchMeanEffectiveLengthFlowWeighted] = Ensemble(omegaDesign,lambda)
%% set-up
close all; more off
...
%% Upgrade 50% of the network in one fell swoop
    ...
    computeMetrics(ODmatrix,flowPath1,edgePath,isEdgeCycle1,lengthEdge,omegaTest);
%% Now instead upgrade in two 25% hits
    ...
    computeMetrics(ODmatrix,flowPath2a,edgePath,isEdgeCycle2a,lengthEdge,omegaTest);
    ...
    computeMetrics(ODmatrix,flowPath2b,edgePath,isEdgeCycle2b,lengthEdge,omegaTest);
%% Four 12.5% hits
% to be implemented
end
%%
